...
dataset_spec = '/rt/csi/test/data2'
x_train,x_val = dataloading(dataset_spec,envir = "indoor",img_channels = 2, img_height = 32, img_width = 32, data_format = "channels_first", T = 10,val_flag = 0)
...
csinet_markov_model = markov_net(img_channels, img_height, img_width,T,encoded_dim_hi,encoded_dim_lo,data_format='channels_first')
...
calc_NMSE(x_hat,x_val,T=10,pow_diff=None)
